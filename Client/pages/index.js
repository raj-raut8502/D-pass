  ...
  const handleConnectWallet = async () => {
    try {
      if (window?.ethereum) {
        ...
        if (chainId !== 43113) {
          setLog({ type: "info", message: "Switching to ganache", description: "Please connect to Ganache Testnet" });
  ...
  return (
    <div className={styles.container}>
      ...
      <footer className={styles.footer}>
        <a
          href="https://github.com/raj-raut8502"
          target="_blank"
          rel="noopener noreferrer"
        >
          © 2024 Developed By Raj Raut, Shubham Kshetre, Prathamesh Nawale
        </a>
      </footer>
    </div>
  );
